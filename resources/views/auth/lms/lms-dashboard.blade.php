...
<div class="tab-content" id="lmsTabsContent">
    <div class="tab-pane fade border border-top-0 rounded-bottom-4 bg-white p-3 show active" id="view-summary" role="tabpanel" aria-labelledby="view-summary-tab">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <a href="{{ route('courses.export') }}" class="btn btn-success">
            ...
            <div class="input-group w-25">
                ...
                <input type="text" id="searchInput" class="form-control border-secondary-subtle rounded-end-4" placeholder="Search Courses">
            </div>
        </div>
