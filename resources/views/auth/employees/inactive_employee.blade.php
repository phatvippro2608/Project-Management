                    ...
                    <table id="employeesTable" class="table table-hover table-borderless">
                        ...
                        @foreach($data as $index => $item)
                            <tr>
                                ...
                                <td class="text-center"><img class="rounded-pill object-fit-cover" src="@if( $item->photo ) {{asset('') . $item->photo}} @else {{asset('assets/img/avt.png')}} @endif" alt="" width="75" height="75"></td>
...
@section('script')
    <script>
        ...
        $(document).on('click', '.btn-reactive', function () {
            if(confirm('Are you sure you want to REACTIVE this employee?')) {
