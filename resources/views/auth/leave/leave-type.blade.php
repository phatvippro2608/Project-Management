                ...
                <div class="modal-body">
                    <form id="addLeaveTypeForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="number_of_days" name="number_of_days" min="0" step="1" required>
                        </div>
                ...
                <div class="modal-body">
                    <form id="editHolidayForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="edit_number_of_days" name="number_of_days" min="0" step="1"
                                required>
                        </div>
