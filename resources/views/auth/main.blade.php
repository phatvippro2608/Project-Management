        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="projects-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{action('App\Http\Controllers\ProjectsController@getViewProgress')}}">
                            <i class="bi bi-circle"></i><span>Progress</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{action('App\Http\Controllers\ProjectsController@getViewExpenses')}}">
            ...
            <li class="nav-item">
                ...
                <ul id="projects-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{action('App\Http\Controllers\ProgressController@getViewProgress')}}">
                            <i class="bi bi-circle"></i><span>Progress</span>
                        </a>
                    </li>
                </ul>
