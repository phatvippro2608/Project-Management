...
<body>
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2">
                            @php
                                $data = \Illuminate\Support\Facades\DB::table('account')
                                    ...
                                    ->where(
                                        'id_account',
                                        \Illuminate\Support\Facades\Request::session()->get(
                                            \App\StaticString::ACCOUNT_ID,
                                        ),
                                    )
                                    ->first();
                            @endphp
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <a class="nav-link collapsed" href="{{ action('App\Http\Controllers\TaskController@getView') }}">
                <i class="bi bi-list-task"></i><span>Report</span>
            </a>
            </li>
        </ul>
