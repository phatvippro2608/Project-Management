                    ...
                    @foreach ($attendance as $data)
                        @php
                            ...
                            if ($data->sign_in && $data->sign_out) {
                                $working_seconds = strtotime($data->sign_out) - strtotime($data->sign_in);
                                $hours = floor($working_seconds / 3600);
                                $minutes = floor(($working_seconds % 3600) / 60);
                                $working = sprintf('%02d:%02d', $hours, $minutes);
                            }
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button data-attendance="{{ $data->attendance_id }}" class="btn p-1 text-primary"
                                    onclick="viewAttendanceByID(this)">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                                |
                                <button data-attendance="{{ $data->attendance_id }}" class="btn p-1 text-danger"
                                    onclick="deleteAttendanceByID(this)">
                ...
                <form id="edit-attendance-form">
                    ...
                    <div class="modal-header">
                        ...
                        <div class="dropdown ms-auto">
                            <button class="btn" type="button" id="dropdownMenu" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <i class="bi bi-three-dots" style="font-size: 3vh;"></i>
                            </button>
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu">
                                <li><a class="dropdown-item" id="dl_attendance" data-attendance="" href="#"
                                        onclick="deleteAttendanceByID(this)">Delete</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="modal-body row">
                        <div class="col-6 mt-3 align-self-center">
                            <div class="form-group text-center">
                                <img id="employee-img" src="{{ asset('assets/img/avt.png') }}"
                            ...
                            <div class="row form-group mt-3">
                                <div class="col-9">
                                    ...
                                    <input id="employee_name" class="form-control" onkeyup="searchDropdown(this)"
                                        onclick="displayDropdown(this)" required>
                                </div>
                                <div class="col-3">
                                    <label class="fw-bolder" for=""><i class="bi bi-person"></i> ID</label>
                                    <input id="employee_id" class="form-control" name="employee_id"
                                    ...
                                    @foreach ($employees as $employee)
                                        ...
                                        <div class="employee-item d-flex align-items-center"
                                            ...
                                            <img src="{{ $photoExists ? $photoPath : $defaultPhoto }}"
                                                class="rounded-circle object-fit-cover ms-2" width="22"
                                                height="22">
                        ...
                        <div class="col-6 mt-3" style="border-left: 1px solid black;">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="time" class="form-control" name="sign_in" id="sign_in"
                                    onchange="timeCheck(this)" required>
                            </div>
                            <div class="form-group mt-3">
                    ...
                    if (data.success) {
                        ...
                        $.each(data.attendance, function(index, value) {
                            ...
                            if (value.sign_in && value.sign_out) {
                                working = new Date(value.date + ' ' + value.sign_out) -
                                    new Date(value.date + ' ' + value.sign_in);
