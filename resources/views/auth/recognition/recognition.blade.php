                ...
                <table id="recognitionTable" class="display">
                    ...
                    @foreach($recognitions as $recognition)
                        <tr class="{{ $recognition->recognition_hidden ? 'hidden-row' : '' }}">
                            ...
                            <td align="center">
                                <button data-recognition="{{ $recognition->recognition_id }}" class="btn btn-primary text-white" onclick="editRecognition(this)"><i class="bi bi-pencil-square"></i></button>
                                <button data-recognition="{{ $recognition->recognition_id }}" class="btn btn-danger text-white" onclick="deleteAttendanceByID(this)" ><i class="bi bi-trash"></i></button>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
